...
* You should not use jQuery. Using JavaScript is not required for this project, but if you use it for a Personal Touch, you should show off your newly learning ES6 skills from lecture!
