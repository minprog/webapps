...
6. GitHub Pages should already be enabled for the repository. If you click on "Deployments" and then on the "View deployment" button, you should be able to see the brief text that is in `README.md`. **However,** due to a bug, you may get a 404 error. In that case, just add a slash (`/`) to the URL and it should work!
